                        ...
                        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                                <li class="nav-item active">
                                    <a class="nav-link" href="#">Geography <span
                                            class="sr-only">(current)</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">Topography</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">Demography</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">Roads</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">Rivers</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
